...
public class Guest extends User {
    ...
    //initate test users
    private static void addNewGuestInitiate(String firstName, String lastName, String address, String postalCode, String city, String country, String telephoneNumber, String emailAddress) {
...
//=======
        for (User userRecord : userListGuest) {
            if (userRecord.getFirstName().equals(firstNameIn)) {
//>>>>>>> hbosch
...
//                userListGuest.add(newUser);
    ...
    private static void guestChanger() {
